...
# SUPER + FUNCTION KEYS
    Key([mod], "g", lazy.spawn('google-chrome-stable --enable-features=VaapiVideoDecoder,VaapiVideoEncoder --disable-features=UseChromeOSDirectVideoDecoder --gtk-version=4')),
    ...
    Key([mod], "m", lazy.spawn('env GDK_SCALE=2 steam')),
    Key([mod], "o", lazy.spawn(home + '/.config/qtile/scripts/logout.sh')),
    Key([mod], "p", lazy.spawn(home + '/.config/qtile/scripts/togglepicom.sh')),
    Key([mod], "i", lazy.spawn(home + '/.config/qtile/scripts/swau.sh')),

# ALACRITTY KEYBINDS
    Key([mod], "n", lazy.spawn(myTerm + ' --class ranger,ranger -e ranger')),
...
# INCREASE/DECREASE/MUTE VOLUME
    ...
    Key([mod], "F8", lazy.spawn("playerctl previous")),
