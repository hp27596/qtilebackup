...
yay -S auto-cpufreq-git betterlockscreen caffeine-ng cava cmus-notify google-chrome i3lock-color material-black-colors-theme ncmatrix nerd-fonts-ubuntu-mono pyrit python-pulsectl sway-launcher-desktop ticker timeshift-bin noto-fonts-emoji-apple mangohud-git ttf-unifont ttf-font-awesome otf-font-awesome protonvpn goverlay ttf-ubuntu-font-family ttf-ms-fonts nuclear-player-bin routersploit-git
